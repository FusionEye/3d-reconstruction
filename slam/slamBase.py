...
class SolvePnP(object):
    ...
    def __init__(self, distCoeffs, CameraIntrinsicData, camera, frame1, frame2):
        ...
        self.frame1 = frame1
        self.frame2 = frame2
        self.rvec, self.tvec, self.inliers = self.ResultOfPnP(self.frame1.kps, self.frame2.kps, self.frame1.des,
                                                              self.frame2.des, self.frame1.depth, self.distCoeffs,
                                                              self.CameraIntrinsicData, self.camera)
